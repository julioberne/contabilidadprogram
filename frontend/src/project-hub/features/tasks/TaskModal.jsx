...
const styles = {
  ...
  heading: { color: C.accent, fontSize: '15px', margin: 0, letterSpacing: '1.5px' },
  closeBtn: {
    background: 'transparent', border: 'none', color: C.dim,
    cursor: 'pointer', fontSize: '16px',
  },
  body: { padding: '20px', overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: '12px' },
  label: { color: C.dim, fontSize: '11px', letterSpacing: '1.5px', display: 'block', marginBottom: '4px' },
  input: {
    background: '#1a1a1a', border: `2px solid #333`, color: C.text,
    padding: '10px 14px', fontSize: '14px', fontFamily: '"IBM Plex Mono", monospace',
    outline: 'none', width: '100%', boxSizing: 'border-box',
  },
  select: {
    background: '#1a1a1a', border: `2px solid #333`, color: C.text,
    padding: '10px 14px', fontSize: '13px', fontFamily: '"IBM Plex Mono", monospace',
  ...
  priorityBtn: {
    ...
    fontSize: '11px', letterSpacing: '1px', fontFamily: '"IBM Plex Mono", monospace',
    transition: 'all .15s',
  },
  ...
  deleteBtn: {
    ...
    padding: '8px 14px', cursor: 'pointer', fontSize: '12px', letterSpacing: '1px',
  ...
  saveBtn: {
    ...
    padding: '9px 22px', cursor: 'pointer', fontSize: '13px',
