...
const colStyles = {
  ...
  label: { flex: 1, color: C.text, fontSize: '13px', letterSpacing: '0.5px', fontFamily: '"IBM Plex Mono", monospace' },
  count: { fontSize: '13px', fontWeight: 700, fontFamily: '"IBM Plex Mono", monospace' },
  cards: { flex: 1, overflowY: 'auto', padding: '10px', display: 'flex', flexDirection: 'column', gap: '8px' },
  addBtn: {
    background: 'transparent', border: 'none', color: C.dim,
    padding: '10px', cursor: 'pointer', fontSize: '12px', textAlign: 'center',
...
const cardStyles = {
  ...
  title: { color: C.text, fontSize: '13px', margin: '0 0 4px', fontFamily: '"IBM Plex Mono", monospace', fontWeight: 600 },
  desc: { color: C.dim, fontSize: '12px', margin: '0 0 8px', lineHeight: 1.5 },
  footer: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  avatars: { display: 'flex', alignItems: 'center' },
  avatar: {
    width: '22px', height: '22px', borderRadius: '50%',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    color: '#000', fontSize: '10px', fontWeight: 700, border: '2px solid #161616',
    fontFamily: '"IBM Plex Mono", monospace',
  },
  deadline: { fontSize: '11px', fontFamily: '"IBM Plex Mono", monospace' },
};
